...
class RnaTranscriptionTest < Minitest::Test
  ...
  def test_correctly_handles_invalid_input_rna_instead_of_dnaskip
    assert_equal '', Complement.of_dna('U')
  end

  def test_correctly_handles_completely_invalid_dna_inputskip
    assert_equal '', Complement.of_dna('XXX')
  end

  def test_correctly_handles_partially_invalid_dna_inputskip
